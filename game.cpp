...
class game{   //parent class which has main logic for the game
  ...
  void start(){   //function which starts the game storyline
    ...
    cout<<"Narrator: First you need to kill the guards "<<endl; sleep(5);
  }
...
void end(){ int h;
  ...
  cout<<"Eva: Good luck "<<name<<endl;sleep(2);
    ...
    cout << "Game Over! You have been killed by the enemy." << endl;sleep(3); //game over message
    cout<<"Press 1 to play again or 2 to exit: "<<endl; cin>>h;
    if(h==1){
      main();
    }
...
class lv2:public game{  //child class to store level 2 enemy details 
    ...
    void echa(){
        ...
        cout<<"Narrator: You stand in front of the dragon and your job is to kill him and aquire the crystal "<<endl; sleep(5);
